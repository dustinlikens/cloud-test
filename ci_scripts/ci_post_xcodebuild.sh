...
gen-ir /Volumes/workspace/veracode/build-log.txt/Volumes/workspace/veracode/veracode.xcarchive --project-path $CI_PROJECT_FILE_PATH
...
#grep -r "ComputeTargetDependencyGraph" /Volumes/workspace/
